...
The Tree Map from the Coe Tree Archive is the easiest way to learn more about the trees around Coe's campus. The interactive nature of the Tree Map makes it a flexible and fast tool to help you connect with the trees around you. For more detailed data on the our trees, see [By the Numbers](https://sites.google.com/coe.edu/coe-tree-archive/by-the-numbers?authuser=0).

Additionally, the Tree Map displays estimates of some of the tangible benefits individual trees offer us, including carbon sequestration, avoided runoff, and reductions in air pollution. These estimates all come from [i-Tree Eco](https://www.google.com/url?q=https%3A%2F%2Fwww.itreetools.org%2Fabout&sa=D&sntz=1&usg=AOvVaw3GOEoGXmmayyppyP6FyRTo), a software product supported by the US Forest Service.

Finally, the Tree Map displays the names, if available, of anyone who helped plant a tree. Many trees planted after the derecho have a metal tag that display the names of the members of the Coe community who helped plant the tree. The Tree Map contains these names as a way to celebrate those who helped rebuild our campus, and to help us all connect the environment around us to the hard work of our community.
