...
The Tree Map from the Coe Tree Archive is the easiest way to learn more about the trees around Coe's campus. The interactive nature of the Tree Map makes it a flexible and fast tool to help you connect with the trees around you. For more detailed data on the our trees, see [By the Numbers](/tree-numbers.qmd).
